...
ax = sns.barplot(x,y,yerror) 
ax.set_ylabel('Average Total SAT Score')
plt.show()

print(stats.f_oneway(district_dict['Brooklyn'], district_dict['Bronkx'], district_dict['Manhattan'], district_dict['Queens'], district_dict['Staten Island']))
districts = ['Brooklyn', 'Bronkx', 'Manhattan', 'Queens', 'Staten Island']
